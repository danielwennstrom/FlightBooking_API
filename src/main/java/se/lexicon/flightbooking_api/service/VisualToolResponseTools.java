...
//    }
    ...
    public String launchDestinationPicker(String message) {
        System.out.println("Launching a visual destination picker...");
        return message + "[LAUNCH_DESTINATION_PICKER]";
    }

    @Tool(description = "Launch a visual flight picker for the user")
    public String launchFlightPicker(String message) {
        System.out.println("Launching a visual flight picker...");
        return message + "[LAUNCH_FLIGHT_PICKER]";
    }
}
